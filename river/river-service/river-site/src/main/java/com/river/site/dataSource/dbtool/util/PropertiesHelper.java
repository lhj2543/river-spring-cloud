...
import com.river.site.dataSource.dbtool.resolver.PropertyPlaceholderConfigurerResolver;
...
public class PropertiesHelper
{
  ...
  private static Properties resolveProperties(Properties props) {
    ...
    for (Iterator localIterator = props.keySet().iterator(); localIterator.hasNext(); ) { Object s = localIterator.next();
